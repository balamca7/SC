...
function themetype_configmodule(id) {
	...
	var link = '?module=dashboard&action=loadthemetype&type=theme&name='+id+'&embedcode=0&ts='+ts;
	$("#admin-modal-body").html("<iframe frameborder='0' height='300px' width='100%' src='"+link+"'></iframe>");
}
...
function themetype_embedcode(id) {
	...
	if(id=="embedded"){
		...
		link = '?module=dashboard&action=themeembedcodesettings&type=theme&name='+id+'&embedcode=1&ts='+ts;
	}else{
		$("#admin-modal-title").text('Embed Link');
		link = '?module=dashboard&action=loadthemetype&type=theme&name=docked&process=true&ts='+ts;
	}
	$("#admin-modal-body").html("<iframe frameborder='0' height='300px' width='100%' src='"+link+"'></iframe>");
