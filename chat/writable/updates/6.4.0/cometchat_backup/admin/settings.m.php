...
function index() {
	global $body, $navigation, $options, $ts, $apikey,$gatrackerid;
	$form = '';
...
function generalsettings() {
	...
	$generalsettings = $licensekey_interface = $changeuserpass_interface = $storage_interface = $caching_interface = $devsettings_interface = '';
	$form = '';
$options = array(
