...
jqcc.extend(jqcc.cometchat, {
    crvariables : {themename: '<?php echo $theme;?>',
            ...
            sendmessageProcess: function(message, currentroom, basedata, currentroomname,localmssgkey) {
                ...
                var localmessageid = jqcc.cometchat.updateOfflinemessages(currentroom, message, localmssgkey, 1);
                ...
                if(localmessageid != '' && localmessageid != 'undefined') {
                    if (typeof(jqcc[jqcc.cometchat.getChatroomVars('calleeAPI')].addChatroomMessage) == "function")
                        jqcc[jqcc.cometchat.getChatroomVars('calleeAPI')].addChatroomMessage({fromid:jqcc.cometchat.getChatroomVars('myid'),message: message,id:localmessageid,selfadded:1,sent:Math.floor(new Date().getTime()),fromname:'0', calledfromsend:'1', roomid:currentroom});
                }
                <?php endif;?>
                if (message != '') {
