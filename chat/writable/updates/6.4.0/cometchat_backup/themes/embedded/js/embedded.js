            ...
            recentList: function(item){
                ...
                $.each(item, function(i, chat){
                    ...
                    if(chat.grp) {
                        ...
                        /*if(chat.type == 1) {
                            roomtype = '<img src="'+baseUrl+'themes/'+settings.theme+'/images/lock.png" />';
                        }*/
                    ...
                    if(jqcc.cometchat.getThemeArray('buddylistName', incoming.from)==null||jqcc.cometchat.getThemeArray('buddylistName', incoming.from)==''){
                        ...
                        if($("#cometchat_message_"+incoming.id).length>0){
                            ...
                            if($("#cometchat_message_"+incoming.localmessageid).length>0){
                                $("#cometchat_message_"+incoming.localmessageid).parent().replaceWith(msg2);
                        ...
                        $.each(params, function(index, item){
                            if(item['g']) {
                                if(item.hasOwnProperty('s') && item['s'] == 1) {
                                    jqcc.cometchat.getChatroomDetails(item['id'],1,1);
                                } else if(item.c > 0) {
